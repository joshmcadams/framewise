...
| [09](09-feature-backlog-next-primitives.md) | Next primitives | Features | ✅ Done (A/F/G) | staticFile, string/color interpolate, Easing, Series/Loop, measureSpring, seeded random, progress. |
